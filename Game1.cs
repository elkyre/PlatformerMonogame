...
namespace PLATFORMER1
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //draw gui in seperat spritebatch
            spriteBatch.Begin();
            spriteBatch.DrawString(arialFont, "Score:" + score.ToString(), new Vector2(20, 20), Color.Purple);

            int loopCount = 0;
            while (loopCount < lives)
            {
                spriteBatch.Draw(heart, new Vector2(GraphicsDevice.Viewport.Width - 60 - loopCount * 28, 20), Color.White);
                loopCount++;
            }
